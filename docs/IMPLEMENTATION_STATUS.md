...
| DB migrations | DONE | 001–049; 027 TimescaleDB; 034 iv_history; 038 option snapshots; 039 market_news; 040 app_config+symbol_data_prefs; 042 FK backtest_runs→definition_scenarios; 043 schema consistency; 044 backtest_runs.initial_capital NUMERIC(18,4); 045-047 indicator+greeks intelligence; 048 quant_conditions + 3 templates; 049 strategy_instances.definition_scenario_id FK |
...
| Broker integrations | DONE | Polly 3× retry+CB; RedisEncryptedTokenStore AES-256-GCM; BrokerRequired=false offline mode; LocalAuth JWT; Zerodha+Upstox fully implement IFullBrokerClient (PlaceOrder/Modify/Cancel/OrderBook/Quote/OptionQuotes/HistoricalData/Depth/Holdings/Positions/Stream/InstrumentMaster/LatencyMeasure); live credential testing is VERIFY_LIVE |
