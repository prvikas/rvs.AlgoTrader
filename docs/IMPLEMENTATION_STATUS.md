...
| Tests | PARTIAL | PriceActionBreakout unit tests pass; integration factory wired; CommissionModelTests (entry+exit commission accounting); StrategyFromJsonTests (VcpSwing/FibOptionSpread/IntradayPcr zero-param + PCR ordering) |
