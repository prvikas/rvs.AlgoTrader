...
| Quant Intelligence (P10-A/B) | DONE | indicator_intelligence (15 cards: ADX/RSI/MACD/ATR/BB/VWAP/Stochastic/EMA/SMA/Supertrend/Volume/OBV/Fibonacci/PivotPoints/PSAR) + greeks_intelligence (7 cards: Delta/Theta/Vega/Gamma/IV/IVP/IndiaVIX); editable cards with EV conditions, misuse warnings, regime context; P10-B: QuantRegimeService (ADX-14 Wilder, ATR ratio, IVP) → 6 regime labels + traffic light + confidence + contributing factors; GET /api/regime/classify; RegimeBadge + RegimePanel; QuantIntelligencePage 3-tab (Regime / Indicators / Greeks) |
| DB migrations | DONE | 001–046; 027 TimescaleDB; 034 iv_history; 038 option snapshots; 039 market_news; 040 app_config+symbol_data_prefs; 042 FK backtest_runs→definition_scenarios; 043 schema consistency (audit_log, signal_journal, allocated_capital, PnL sync trigger); 044 backtest_runs.initial_capital NUMERIC(18,4) |
