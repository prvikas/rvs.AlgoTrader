...
| DB migrations | DONE | DatabaseMigrationRunner auto-discovers *.sql; migrations 001–024 applied; 024 fixes #202 (AvgPrice comments+UpdateAvgPrice), #203 (realized_pnl backfill+NOT NULL), #212 (correlation_id DROP DEFAULT ''), idempotent re-guards for 020 CHECKs |
...
| Forward test engine | PARTIAL | ForwardTestEngine skeleton wired; FinalCapital now persisted on stop (#184); SL/TP close logic present; full candle-feed wiring NOT_REVIEWED |
