...
| Quant Intelligence (P10-A) | DONE | indicator_intelligence + greeks_intelligence tables; editable cards for 7 indicators (ADX/RSI/MACD/ATR/BB/VWAP/Stochastic) + 7 Greeks (Delta/Theta/Vega/Gamma/IV/IVP/IndiaVIX); IIndicatorIntelligenceService + IGreeksIntelligenceService; 2 controllers; IntelligenceInfoButton + card drawer components; QuantIntelligencePage under Research > Quant Intel |
